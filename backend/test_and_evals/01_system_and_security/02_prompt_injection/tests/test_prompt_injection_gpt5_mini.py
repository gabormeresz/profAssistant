"""
Test 1.2c — LLM-Level Prompt Injection Resistance (gpt-5-mini)
================================================================

Validates that **gpt-5-mini** (reasoning model) ignores prompt injection
payloads when they pass through the full defense-in-depth pipeline.

All 14 LLM calls fire concurrently via ``asyncio.gather``.
"""
...
async def llm_responses():
    """Fire all LLM calls for gpt-5-mini and cache the results."""
