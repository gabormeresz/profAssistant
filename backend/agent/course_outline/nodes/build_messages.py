"""
Message construction node for the course outline generation workflow.
"""
...
def _build_first_call_messages(state: CourseOutlineState) -> dict:
    """
...
def _build_follow_up_messages(state: CourseOutlineState) -> dict:
    """
